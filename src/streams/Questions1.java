...
public class Questions1 {
    public static void main(String[] args) {
        ...
        Employee q8 = employeeList.stream()
                ...
                .min(Comparator.comparing(Employee::getAge)).orElseGet(() -> null);
        System.out.println(q8);
        System.out.println("----------");

        System.out.println("Who has the most working experience in the organization?");
        Employee q9 = employeeList.stream()
                .min(Comparator.comparing(Employee::getYearOfJoining)).orElseGet(() -> null);
        ...
        Employee q12 = employeeList.stream()
                .max(Comparator.comparing(Employee::getAge)).orElseGet(() -> null);
